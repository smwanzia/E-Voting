<%-- 
    Document   : error
    Created on : Mar 24, 2018, 10:42:56 PM
    Author     : xmore mmohz
--%>
                ...
                <div class="row">
                    <div clas="col-md-12">
                        <div class="success" style="margin-top: 130px;">
                              <h3 style="text-align: center; font-size: 25px;color:red">ERROR 404 <i class="fa fa-remove"></i></h3>
                              <h1 style="color:darkred;text-align: center; padding-bottom: : 20px">${vote}</h1>
                        </div>
                    </div>
                </div>
